...
<figure class="seventy">
  <Image src="./three_sixteenths.jpg" />
...
We're used to writing numbers in decimal (base 10), where `0.abc` would mean <Fraction numerator="a" denominator="10" /> + <Fraction numerator="b"><span slot="denominator">10<sup>2</sup></Fraction> + <Fraction numerator="c"><span slot="denominator">10<sup>3</sup></Fraction>. In binary (base 2), `0.abc` would mean <Fraction numerator="a" denominator="2" /> + <Fraction numerator="b"><span slot="denominator">2<sup>2</sup></Fraction> + <Fraction numerator="c"><span slot="denominator">2<sup>3</sup></Fraction>. So we could write 5/8 as <Fraction numerator="1" denominator="2" /> + <Fraction numerator="0" denominator="4" /> + <Fraction numerator="1" denominator="8" /> = 0.101<sub>2</sub>. (The little subscript 2 is saying 'this number is written in base 2')
