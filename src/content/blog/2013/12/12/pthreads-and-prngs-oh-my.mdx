...
<figure>
   <Image src={pthreads_prng_austin_post} alt="Austin's post reading: Idea for a random generator... Use two threads to set a bool to opposite values then poll the bool for its value. Pretty hard to guess what it's going to be..." />
</figure>
